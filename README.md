[![npm version](https://img.shields.io/npm/v/@diotoborg/perferendis-inventore.svg)](https://www.npmjs.com/package/@diotoborg/perferendis-inventore)
[![npm downloads](https://img.shields.io/npm/dm/@diotoborg/perferendis-inventore.svg)](https://www.npmjs.com/package/@diotoborg/perferendis-inventore)
[![Build Status](https://github.com/diotoborg/perferendis-inventore/workflows/CI/badge.svg)](https://github.com/diotoborg/perferendis-inventore/actions)
...
```
npm i @diotoborg/perferendis-inventore
```

To use in an ESM file:

```js
import * as @diotoborg/perferendis-inventore from "@diotoborg/perferendis-inventore";

const ast = @diotoborg/perferendis-inventore.parse(code);
```

To use in a Common JS file:

```js
const @diotoborg/perferendis-inventore = require("@diotoborg/perferendis-inventore");
...
```js
const ast = @diotoborg/perferendis-inventore.parse('let foo = "bar"', { ecmaVersion: 6 });
console.log(ast);
```
...
const tokens = @diotoborg/perferendis-inventore.tokenize('let foo = "bar"', { ecmaVersion: 6 });
console.log(tokens);
```
...
Returns the current `@diotoborg/perferendis-inventore` version
...
Returns the latest ECMAScript supported by `@diotoborg/perferendis-inventore`
...
Issues and pull requests will be triaged and responded to as quickly as possible. We operate under the [ESLint Contributor Guidelines](http://eslint.org/docs/developer-guide/contributing), so please be sure to read them before contributing. If you're not sure where to dig in, check out the [issues](https://github.com/diotoborg/perferendis-inventore/issues).
